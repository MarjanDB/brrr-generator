...
![Lokacija Flex Queries](../images/flex-queries-location.png) ![Kako ustvarit Flex Query](../images/flex-query-new.png)
...
3. Zaženi celice v .ipynb datoteki specifični za dokument ki pripravljaš (`./notebooks` mapa) (v .ipynb datoteki popravi datume za leto
   katero hočeš imet generiran izvoz)
