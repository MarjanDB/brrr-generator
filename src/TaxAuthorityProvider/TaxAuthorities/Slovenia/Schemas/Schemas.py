...
class EDavkiTradeSecurityType(str, Enum):
    ...
    SECURITY_WITH_CONTRACT = (
        "PLVPG"  # Popisni list vrednostnega papirja, ki je v gospodarjenju pri borznoposredniški družbi na podlagi pogodbe o gospodarjenju
    )
