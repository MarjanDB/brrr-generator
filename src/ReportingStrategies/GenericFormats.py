...
class GenericUnderlyingGroupingStaging:
    ...
    DerivativeTrades: Sequence[
        TradeEventStagingDerivativeAcquired | TradeEventStagingDerivativeSold
    ]
...
@dataclass
class TradeTaxLotEventStock(
    GenericTaxLot[TradeEventStockAcquired, TradeEventStockSold]
): ...


@dataclass
class TradeTaxLotEventDerivative(
    GenericTaxLot[TradeEventDerivativeAcquired, TradeEventDerivativeSold]
): ...
...
class GenericDerivativeReportAssetClassType(str, Enum):
    FUTURES_CONTRACT = (
        "FUTURES_CONTRACT"  # https://www.investopedia.com/terms/f/futurescontract.asp
    )
...
class GenericDerivativeReportItem:
    ...
    Lines: list[
        GenericDerivativeReportItemSecurityLineBought
        | GenericDerivativeReportItemSecurityLineSold
    ]
