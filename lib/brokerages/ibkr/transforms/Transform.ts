...
import { GenericAssetClass, GenericCategory, GenericDerivativeReportItemGainType, GenericDividendType, GenericShortLong, GenericTradeReportItemGainType } from "@brrr/core/schemas/CommonFormats.ts";
...
export function convertSegmentedTradesToGenericUnderlyingGroups(
  ...
  for (const key of allKeys) {
    ...
    groupings.push({
      ...
      derivativeTrades: (derivativesMap.get(key)?.items ?? []) as (StagingTradeEventDerivativeAcquired | StagingTradeEventDerivativeSold)[],
